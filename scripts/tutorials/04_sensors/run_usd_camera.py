...
def run_simulator(sim: sim_utils.SimulationContext, scene_entities: dict):
    ...
    while simulation_app.is_running():
        ...
        if sim.has_gui(
            ...
            pointcloud, _ = create_pointcloud_from_rgbd(
                intrinsic_matrix=camera.data.intrinsic_matrices[camera_index],
                depth=camera.data.output[camera_index]
                ["distance_to_image_plane"],
                rgb=camera.data.output[camera_index]["rgb"],
            ...
            if pointcloud.size()[0] > 0:
                ...
                o3d_pc = vis_pc(pointcloud.cpu().numpy())
                coordinate_axes = o3d.geometry.TriangleMesh.create_coordinate_frame(
                    size=0.5, origin=[0, 0, 0])
                o3d.visualization.draw_geometries([o3d_pc, coordinate_axes])
