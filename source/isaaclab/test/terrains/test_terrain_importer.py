...
class TestTerrainImporter(unittest.TestCase):
                ...
                for num_envs in [1, 4, 125, 379, 1024]:
                    with self.subTest(num_envs=num_envs,
                        ...
                        with build_simulation_context(
                                device=device, auto_add_lighting=True) as sim:
                            ...
                            terrain_importer_cfg = TerrainImporterCfg(
                                ...
                                terrain_type=
                                "plane",  # for flat ground, origins are in grid
    ...
    def test_terrain_generation(self) -> None:
        ...
        for device in ("cuda:0", "cpu"):
            with build_simulation_context(device=device,
                ...
                expectedSizeX = cfg.size[
                    0] * cfg.num_rows + 2 * cfg.border_width
                expectedSizeY = cfg.size[
                    1] * cfg.num_cols + 2 * cfg.border_width
    ...
    def _populate_scene(self,
        ...
        prim_utils.define_prim(prim_path="/World/envs/env_0",
                               prim_type="Xform")
        ...
        if geom_sphere:
            ...
            SingleGeometryPrim(prim_path="/World/envs/env_0/ball",
                               collision=True)
