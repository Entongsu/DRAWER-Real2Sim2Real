...
class ManagerBasedRLEnv(ManagerBasedEnv, gym.Env):
    ...
    def step(self, action: torch.Tensor) -> VecEnvStepReturn:
        ...
        for _ in range(self.cfg.decimation):
            ...
            if self._sim_step_counter % self.cfg.sim.render_interval == 0 and is_rendering and self.set_rendering:
                self.sim.render()
        ...
        self.reward_buf = torch.nan_to_num(self.reward_buf, nan=0.0)
        ...
        for group_name, group_term_names in self.observation_manager.active_terms.items(
            ...
            if has_concatenated_obs:
                ...
                self.single_observation_space[group_name] = gym.spaces.Dict({
                    term_name:
                    gym.spaces.Box(low=-np.inf, high=np.inf, shape=term_dim)
