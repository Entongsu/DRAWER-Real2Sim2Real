...
class CameraCfg(SensorBaseCfg):
    ...
    * ``"typeA : * ; * : labelA"``: All prims with semantic type "typeA" or with label "labelA"
    ...
    colorize_semantic_segmentation: bool = False
    ...
    colorize_instance_id_segmentation: bool = False
    ...
    segmentation_point_cloud: bool = False

    colorize_point_cloud: bool = False

    num_downsampled_points: int = 2048

    segmentation_point_cloud_id: int = 0
