...
@configclass
class ParticleBodyPropertiesCfg:

    Pressure: float | None = None
    # particle_groups: float | None = None
    self_collision: bool = True
    self_collision_filter: float | None = None
    ...
    rest_offset: float | None = None
    collision_offset: float | None = None
    Solid_Rest_Offset: float = 0.05
