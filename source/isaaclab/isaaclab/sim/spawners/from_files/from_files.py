...
def _spawn_from_usd_file(
    ...
    if cfg.deformable_props is not None:
        ...
        if cfg.deformable_props.deformable_enabled:

            schemas.define_deformable_body_properties(prim_path,
        ...
        if cfg.mass_props is not None:
            ...
            schemas.define_mass_properties(mesh_path, cfg.mass_props, stage)
            schemas.modify_mass_properties(mesh_path, cfg.mass_props)
    if cfg.particle_props is not None:
        schemas.modify_particle_body_properties(prim_path, cfg.particle_props)
