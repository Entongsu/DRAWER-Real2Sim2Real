...
@configclass
class ParticleBodyMaterialCfg(PhysicsMaterialCfg):

    Friction: float | None = None
    particleFrictionScale: float | None = None
    Damping: float | None = None
    Viscosity: float | None = None
    VorticityConfinement: float | None = None
    SurfaceTension: float | None = None
    Cohesion: float | None = None
    Adhesion: float | None = None
    ParticleAdhesionScale: float | None = None
    AdhesionOffsetScale: float | None = None
    Lift: float | None = None
    Drag: float | None = None
    Density: float | None = None
    CflCoefficient: float | None = None
