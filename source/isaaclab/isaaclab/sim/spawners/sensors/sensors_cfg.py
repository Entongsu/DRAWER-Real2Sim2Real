...
class PinholeCameraCfg(SpawnerCfg):
    ...
    def from_intrinsic_matrix(
        ...
        return cls(
            ...
            f_stop=f_stop,
            horizontal_aperture=horizontal_aperture.item(),
            vertical_aperture=vertical_aperture.item(),
            horizontal_aperture_offset=horizontal_aperture_offset.item(),
            vertical_aperture_offset=vertical_aperture_offset.item(),
